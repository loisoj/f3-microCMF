<?php
    ...
    class ConstructrContent extends ConstructrBase
    {
        ...
        public function content_init($APP){
            ...
            echo Template::instance()->render('protected/TEMPLATES/constructr_admin_content.html','text/html');
        }
        ...
        public function content_new_before($APP){
            ...
            echo Template::instance()->render('protected/TEMPLATES/constructr_admin_content_new_before.html','text/html');
        }
        ...
        public function content_new_after($APP){
            ...
            echo Template::instance()->render('protected/TEMPLATES/constructr_admin_content_new_after.html','text/html');
        }
        ...
        public function content_new($APP){
            ...
            echo Template::instance()->render('protected/TEMPLATES/constructr_admin_content_new.html','text/html');
        }
        ...
        public function content_edit($APP){
            ...
            if ($APP->get('CONTENT_COUNTR')==1){
                echo Template::instance()->render('protected/TEMPLATES/constructr_admin_content_edit.html','text/html');
            } else {
