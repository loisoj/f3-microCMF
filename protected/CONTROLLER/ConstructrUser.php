<?php
    ...
    class ConstructrUser extends ConstructrBase
    {
        ...
        public function user_management($APP){
            ...
            echo Template::instance()->render('protected/TEMPLATES/constructr_admin_usermanagement.html','text/html');
        }
		...
		public function user_management_edit_rights($APP){
			...
			echo Template::instance()->render('protected/TEMPLATES/constructr_admin_usermanagement_edit_rights.html','text/html');
		}
        ...
        public function user_management_new($APP){
            ...
            echo Template::instance()->render('protected/TEMPLATES/constructr_admin_usermanagement_new.html','text/html');
        }
        ...
        public function user_management_edit($APP){
            ...
            echo Template::instance()->render('protected/TEMPLATES/constructr_admin_usermanagement_edit.html','text/html');
        }
