<?php
    ...
    class ConstructrBase
    {
        ...
        public function no_rights($APP){
        	$APP->set('ACT_VIEW','');
            echo Template::instance()->render('protected/TEMPLATES/constructr_admin_no_rights.html','text/html');
        }
        ...
        public function init($APP){
            ...
            echo Template::instance()->render('protected/TEMPLATES/index.html','text/html');
        }
        ...
        public function login_step_2($APP){
            ...
            echo Template::instance()->render('protected/TEMPLATES/index_step_2.html','text/html');
        }
        ...
        public function login_error($APP){
            ...
            echo Template::instance()->render('protected/TEMPLATES/index_login_error.html','text/html');
        }
        ...
        public function updated_user_credentials($APP){
            ...
            echo Template::instance()->render('protected/TEMPLATES/updated-user-credentials.html','text/html');
        }
