    ...
    class ConstructrUploads extends ConstructrBase
    {
        ...
        public function uploads_init($APP){
			...
			if($APP->get('GET.needle')){
				...
				echo Template::instance()->render('protected/TEMPLATES/constructr_admin_uploads.html','text/html');
			} else {
	            $H=opendir($APP->get('uploads'));
				$i=0;
        ...
        public function uploads_edit_file($APP){
            ...
            echo Template::instance()->render('protected/TEMPLATES/constructr_admin_uploads_edit.html','text/html');
        }
        ...
        public function uploads_new($APP){
            ...
            echo Template::instance()->render('protected/TEMPLATES/constructr_admin_uploads_new.html','text/html');
        }
